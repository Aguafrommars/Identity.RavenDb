...
namespace Aguacongas.Identity.RavenDb
{
        ...
        where TUserToken : IdentityUserToken<TKey>, new()
    {
        ...
        protected RavenDbUserStoreBase(IdentityErrorDescriber describer)
        {
    ...
    [SuppressMessage("Critical Code Smell", "S1006:Method overrides should not change parameter defaults", Justification = "<Pending>")]
    public abstract class RavenDbUserStoreBase<TUser, TKey, TRole, TUserClaim, TUserRole, TUserLogin, TUserToken, TRoleClaim> :
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        /// </summary>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/> used to describe store errors.</param>
        protected RavenDbUserStoreBase(IdentityErrorDescriber describer) : base(describer) { }
